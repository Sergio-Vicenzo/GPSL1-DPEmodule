...
%% Coordinate conversion ==================================================
    ...
    [navSolutions] = DPE_module...
        ...
        transmitTime(activeChnList),localTime,codePhase,...
    ...
    % === Prints the errors of both Least Squares and DPE =================
    % Added by Sergio Vicenzo - 14 Feb 2024
    fprintf('\nCurrent Error of DPE     : %1f\n',...
        (navSolutions.LLH_error(currMeasNr,2)));
    fprintf('Current Error of LS      : %1f\n',...
        (navSolutions.LLH_error(currMeasNr,1)));
...
saveas(gcf, ...
    ...
    settings.outfile_root,'_Positioning Error']);
saveas(gcf, ...
    [pwd ,'\',settings.outfile_root,'\',...
    settings.outfile_root,'_Positioning Error.png']);
