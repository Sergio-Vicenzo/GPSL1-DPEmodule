...
%% Acquisition ============================================================
    ...
    if ( ...
            ~exist([settings.outfile_root, '\acqResults_gps_', settings.outfile_root...
                    ,'.mat']))
...
% Added by Sergio Vicenzo - 06 Jan 2025
        if ~exist([settings.outfile_root, '\trackResults_gps_MMT_',...
            ...
            % Added by Sergio Vicenzo - 31 July 2024
...
%% Calculate navigation solutions =========================================
    ...
    [navSolutions, ~] = postNavigation(trackResults, settings, fid);
