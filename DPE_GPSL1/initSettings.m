...
settings.samplingFreq       = 26e6;%26e6;%58e6;%58e6;%26e6;%58e6;        % [Hz]
...
% settings.gt_llh = [22.30366385 114.18556947 13]; % HH Hall 2nd floor
% settings.gt_llh = [22.30477703, 114.18030159, 11.591]; %30 DEC 2022
% settings.gt_llh = [22.309553999999999,	114.2090900000000,	6]; %D_200427_KLB_Opensky_gps_185s

% settings.gt_llh = [22.30400269, 114.17890118, 9.849]; % ch1_20251009_091921

% settings.gt_llh = [22.30397817, 114.17889417, 9.9]; % 27Oct2025_L1CA / 27Oct2025_ch1

% settings.gt_llh = [22.30400776,	114.1788973, 10.671]; % ch1_20251119_101303 / COM6___9600_251119_100602
% settings.gt_llh = [22.30396403	114.1788868	10.707]; % ch1_20251119_152313
...
% settings.gt_llh = [22.30221382 114.1548276 2.319298499]; % HaiDi vegetation file
% settings.gt_llh = [22.30397720 114.17889380 10.770] ; %30 May 2024
%% DPE config =============================================================
...
%ch1_20250423_101058
% settings.ALPHA              = [2.7940D-08  1.4901D-08 -1.7881D-07 -5.9605D-08];
% settings.BETA               = [1.3107D+05  6.5536D+04 -2.6214D+05  2.6214D+05];

%File_045
% settings.ALPHA              = [1.9558D-08  2.2352D-08 -1.1921D-07 -1.1921D-07];
% settings.BETA               = [1.2698D+05  1.4746D+05 -1.9661D+05 -1.9661D+05];

%D_20191230_TSTEb_GPS_1713
% settings.ALPHA              = [7.4506D-09 -1.4901D-08 -5.9605D-08  1.1921D-07];
% settings.BETA               = [9.2160D+04 -1.1469D+05 -1.3107D+05  7.2090D+05];

% ch1_20251009_091921
% settings.ALPHA              = [1.9558e-08  0.0000e+00 -1.1921e-07  0.0000e+00];
% settings.BETA               = [1.2288e+05 -1.6384e+04 -2.6214e+05  1.9661e+05];

% 27Oct2025_L1CA / 27Oct2025_ch1
settings.ALPHA              = [0.2049D-07  -0.7451D-08  -0.1192D-06   0.5960D-07];
settings.BETA               = [0.1249D+06  -0.3277D+05  -0.2621D+06   0.1311D+06];


% ch1_20251113_085008
% settings.ALPHA              = [3.0734D-08  0.0000D+00 -1.1921D-07  1.7881D-07];
% settings.BETA               = [1.4131D+05 -9.8304D+04  6.5536D+04 -3.9322D+05];
