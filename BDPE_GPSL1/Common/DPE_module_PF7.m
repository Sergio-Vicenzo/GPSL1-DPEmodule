...
if N_eff < (2/3)*numberOfparticles%(1/4)*numberOfparticles%(2/3)*numberOfparticles
    % function idx = multinomialResample(w, N)
    % w : 1×M normalised weight vector
    % N : desired number of resampled particles
    % M   = numel(weight);
...
% navSolutions.DPE_pureClkBias=DPE_pureClkBias+DPE_clkBias;
