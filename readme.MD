...
DPE_module v1.0 was written by Sergio Vicenzo, inspired by the multicorrelator-based DPE (Corr-DPE) introduced written by HaoSheng Xu and Bing Xu (Vicenzo et al. 2023).
