...
## Declaration
I, Sergio Vicenzo, hereby do not claim ownership or responsibility for Prof. Borre's and Prof. Akos' SOftGNSS v.3.0. All the changes made to the SoftGNSS v3.0 software have been labelled in the code and the GNU license kept in each file, in accordance to GNU General Public License.
