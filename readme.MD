# DPE_module
An open-source GNSS Direct Position Estimation (DPE) and Multipath Mitigation Technology (MMT)-integrated DPE Plug-in Module for Two-Step Positioning SDRs, integrated into SoftGNSS v3.0 by Borre et al. (2007)
