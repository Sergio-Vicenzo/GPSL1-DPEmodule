...
NOTE: DPE_GPSL1 (Conventional DPE) is only configured to run on zero (0) Hertz intermediate frequency (IF) datasets. Modifications are required to run non-zero IF data.
