...
% i.e., deduct the actual full length by 1100 ms
% This is necessary for locating bit transition in tracking.m
settings.msToProcess        = 120000;        %[ms]
...
% based only. 
settings.skipNumberOfBytes     = 0*26e6;
...
% up acquisition
settings.acqSatelliteList   = 1:32;%[14 16 27 31 32];         %[PRN numbers]
...
% settings.gt_llh = [22.3040136000000	114.178904100000	9.86600000000000]; %'7Dec2022_B210_3'
% settings.gt_llh = [22.309554 114.209090 6]; %D_200427_KLB_Opensky_gps_185s
% settings.gt_llh = [22.299866 114.180036 3]; % D_20191230_TSTEb_GPS_1702
...
%% Corr-DPE spacing here
settings.chipspacing_dpe_precalc = 0.05;
