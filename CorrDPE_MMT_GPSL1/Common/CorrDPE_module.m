function [navSolutions]=CorrDPE_module...
...
% CorrDPE_module is consist of an upgraded Corr-DPE algorithm. 
% Using multipath parameter estimates from Multipath Mitigation Technology 
% (MMT), the following code oofers more robust positioning in urban 
% environments.
%
%
% [navSolutions] = CorrDPE_module...
%   (currMeasNr,navSolutions,activeChnList,trackResults,currMeasSample,...
